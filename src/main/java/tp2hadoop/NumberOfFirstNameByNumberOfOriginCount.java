...
//Count number of first name by number of origin input: prenoms.csv like(firstname;sexe;nationality1, nationality2, ...;number) ouput: numberOfOrigins, numberOfFristname
public class NumberOfFirstNameByNumberOfOriginCount {
    ...
    public static class TokenizerMapper extends Mapper<Object, Text, Text, IntWritable> {
        ...
        public void map(Object key, Text value, Context context) throws IOException, InterruptedException {
            ...
            word.set(String.valueOf(origins.length)); //key = number of origins
    ...
    public static void main(String[] args) throws Exception {
        ...
        Job job = Job.getInstance(conf, "NumberOfFirstnameByNumberOfOriginCount"); //create new job
        job.setJarByClass(NumberOfFirstNameByNumberOfOriginCount.class); //set the job jar

        job.setMapperClass(NumberOfFirstNameByNumberOfOriginCount.TokenizerMapper.class); //mapper
        job.setCombinerClass(NumberOfFirstNameByNumberOfOriginCount.IntSumReducer.class); //combiner
        job.setReducerClass(NumberOfFirstNameByNumberOfOriginCount.IntSumReducer.class); //reducer
